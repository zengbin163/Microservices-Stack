...
@Component
public class ConsumerNotifyListener {

	private static final Logger log = LoggerFactory.getLogger(ConsumerNotifyListener.class);
	private static final String TOPIC = Topic.TOPIC_FOOD;
